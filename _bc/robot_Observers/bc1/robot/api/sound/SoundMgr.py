...
#         print self.record_controller.is_on()
        return self.do_record #not self.record_controller.is_on()
...
#                     Common.tty_print('Recording waited  for button and it was not pressed')
#                     return False
...
#         "Records from the microphone and outputs the resulting data to 'path'"
        ...
        def event_listener(self, event_name):
            if event_name == Constants.EVENT_BUTTON_HOLD:
                if self.do_record == False:
                    self.record_to_file(path)
                self.do_record = True
            if event_name == Constants.EVENT_BUTTON_NOT_HOLD:
                self.do_record = False

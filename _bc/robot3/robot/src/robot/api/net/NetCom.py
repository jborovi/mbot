...
#                     print last_score
                    ...
                    Common.tty_print('checking tone:'+str(this_tone))
                    Common.tty_print('tone value:' + str(this_score))                    
                    if this_score >= last_score:
                        last_tone = this_tone
                        last_score = this_score
        Common.tty_print('The tone is'+str(last_tone))
        return last_tone
...
#             audio = r.listen(source)
        Common.tty_print("Sending recorded sound for analyze ...") 
...
#             f.write(audio.get_wav_data())
    ...
    def analyze(self,txt):
        ...
        analyze_res = tone_analyzer.tone(text=txt)
            # 
            # 
        Common.tty_print("Tone is:"+self.get_tone(analyze_res)) 

...
#         print 'MAIN thread dead'
    ...
    def init_threads(self):
        ...
        #checking input from the range sensor every 1 second and manipulating the states based on the event logic
        ...
        #displays demomode untile demomode event is clear
...
def main(argv=None):
    ...
    try:
#         import os
#         os.system('audio_Reset_paths.sh')
#         print 'init record'
#         os.system('audio_Record_from_lineIn_Micbias.sh')
#         print "init playback"
#         os.system('audio_Playback_to_Lineout.sh')
#         print 'init finished'

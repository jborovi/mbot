...
#         print 'is sillent'
#         print (not EventsManager.button_is_pressed.isSet())
#         if millis() - self.start > 5000:
#             return True
#         else:
#             return False
        
        return not EventsManager.button_is_pressed.isSet()
#         return max(data_chunk) < self.THRESHOLD
    ...
    def record(self):
        ...
        while True:
            ...
            data_chunk = array('h', stream.read(self.CHUNK_SIZE, exception_on_overflow=False))
            if byteorder == 'big':
                data_chunk.byteswap()
...
# #                     print Constants.BUTTON_WAIT_RECORD
#                     Common.tty_print(text='Recording waited for button and it was not pressed', newDialog=True)
#                     return False
#                 
...
#         while EventsManager.bigButtonActivated.isSet():
#             if self.record_controller.is_on():
# #                 self.light_controller.change_status(self.record_controller.is_on())
#                 break
#             else:
...
#     print("Wait in silence to begin recording; wait in silence to terminate")
    smgr = SoundMgr(None)
    smgr.record_to_file('/home/honza/_tmp/demo.wav')

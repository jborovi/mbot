        ...
        for category in tone_categories:
            if category['category_id']!='emotion_tone':
                ...
                for tone in tones:
                    ...
                    if this_tone == 'anger':
                        GUI_EventsManager.conversation_tone_result_anger.text = str(this_tone) +" "+ str(int(round(this_score*100)))+"%"
#                         Common.tty_print(text=str(this_tone) +" "+ str(round(this_score*100))+"%", color='red')
                    if this_tone == 'disgust':
                        GUI_EventsManager.conversation_tone_result_disgust.text = str(this_tone) +" "+ str(int(round(this_score*100)))+"%"
#                         Common.tty_print(text=str(this_tone) +" "+ str(round(this_score*100,3))+"%", color='yellow')
                    if this_tone == 'fear':
                        GUI_EventsManager.conversation_tone_result_fear.text = str(this_tone) +" "+ str(int(round(this_score*100)))+"%"
#                         Common.tty_print(text=str(this_tone) +" "+ str(round(this_score*100))+"%", color='white')
                    if this_tone == 'sadness':
                        GUI_EventsManager.conversation_tone_result_sadness.text = str(this_tone) +" "+ str(int(round(this_score*100)))+"%"
#                         Common.tty_print(text=str(this_tone) +" "+ str(round(this_score*100))+"%", color='cyan')
                    if this_tone == 'joy':
                        GUI_EventsManager.conversation_tone_result_joy.text = str(this_tone) +" "+ str(int(round(this_score*100)))+"%"
